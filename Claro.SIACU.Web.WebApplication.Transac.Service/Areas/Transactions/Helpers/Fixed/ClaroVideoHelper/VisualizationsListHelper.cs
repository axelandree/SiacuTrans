...
{
    public class VisualizationsListHelper
    {
        public List<VisualizationHelper> visualization { get; set; }
        // LISTAS PARA LAS GRID
        public List<HELPER_ITEM.ListVisualizationUser> ListVisualizationUser { get; set; }
    }
}