...
namespace Claro.SIACU.Web.WebApplication.Transac.Service.Areas.Transactions.Helpers.Postpaid.UnbilledOutCallDetail
{
    public class CallDetail : IExcel
    {
        ...
        //public double Consumption_Soles { get; set; }
