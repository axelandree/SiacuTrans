...
namespace Claro.SIACU.Web.WebApplication.Transac.Service.Areas.Transactions.Helpers.HFC.ExternalInternalTransfer
{
    public class ExtIntTransfer
    {
        ...
        public string DescrpCountry { get; set; }
        public string ddlDepDes { get; set; }
        public string ddlNoteDepartment { get; set; }
        public string hdnDepDes { get; set; }
        public string hdnProDes { get; set; }
        public string hdnDisDes { get; set; }
        public string hdnCodEdi { get; set; }
        ...
        public string strFlagReservation { get; set; }
        public string strNroOrderToa { get; set; }
