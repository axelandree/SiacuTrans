...
namespace Claro.SIACU.Web.WebApplication.Transac.Service.Areas.Transactions.Helpers.HFC.MigrationPlan
{
    public class ParametersSaved
    {
        ...
        public string StrReintegro { get; set; }
        public string StrMontoFideliza { get; set; }
        public string StrTotalPenalty { get; set; }
        public string StrFidelizaFinalStatus { get; set; }
        public string StrOCCFinalStatus { get; set; }
        public string StrDocumentType { get; set; }
        public string StrValidaETAStatus { get; set; }
        public string StrCustomerContact { get; set; }
        public string StrContractID { get; set; }
        public string StrHayServicioCoreTelefono { get; set; }
        public string StrFProgramacion { get; set; }
        public string StrCustomerType { get; set; }
        public string StrCargoFijoTotalPlanCIGV { get; set; }
        public string StrCustomerID { get; set; }
        public string StrFranjaHorariaETA { get; set; }
        public string StrHdnListaFTMCode { get; set; }
        public string StrHdnCodigoPlan { get; set; }
        public string StrEmail { get; set; }
        public string StrCodMoTot { get; set; }
        public string ConstanceXml { get; set; }
        public string TipoProducto { get; set; }
        public string StrHdnValidaEta { get; set; }
        public string StrDdlOperator { get; set; }
        public string StrHdnRequestActId { get; set; }
        public string strVisitTecAnotaciones { get; set; }
        public string StrFranjaHora { get; set; }
