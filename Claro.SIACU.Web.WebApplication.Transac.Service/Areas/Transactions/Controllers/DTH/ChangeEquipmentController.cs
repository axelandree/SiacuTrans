...
namespace Claro.SIACU.Web.WebApplication.Transac.Service.Areas.Transactions.Controllers.DTH
{
    public class ChangeEquipmentController : CommonServicesController
    {
        ...
        #region ShowViews
        public ActionResult DTHChangeEquipment()
        {
            return PartialView();
        }
        public ActionResult DTHChangeEquipmentAssociate(string currentEquipmentTypeSelected, string limitEquipmentsPerCustomer, string associateEquipmentsPerCustomer, string strEquipmentAssociateUsed)
        {
            ...
            return PartialView("~/Areas/Transactions/Views/ChangeEquipment/DTHChangeEquipmentAssociate.cshtml");
        }
        #endregion

        #region LoadMethods
        [HttpPost]
        public JsonResult DTHChangeEquipmentLoad(RequestDataModel objModel)
        {
            var objChangeEquipmentLoadModel = new ChangeEquipmentLoadModel();
            try
            {
                Claro.Web.Logging.Info(objModel.strIdSession, "ChangeEquipment: ", string.Format("ExecuteDTHChangeEquipmentLoad() - CustomerContractID: {0}", objModel.strIdContract));
                ...
                var objtipification = LoadTypifications(objModel.strIdSession, GetValueConfig("strTipTransCambioEquipoDTH", objModel.strIdSession, ConfigurationManager.AppSettings("strTipTransCambioEquipoDTH")), ref strMessageResult);
                ...
                objChangeEquipmentLoadModel.strAmountToPay = GetValueConfig("strMontoAPagarCambioEquipoDTH", objModel.strIdSession, KEY.AppSettings("strNombreTransaccionCambioEquipo"));
                ...
                objChangeEquipmentLoadModel.lstTypeWork = GetTypeWorkListDTH(objModel.strIdSession, Convert.ToInt(KEY.AppSettings("strTipoTrabajoCambioEquipoLTE")));
               ...
               objChangeEquipmentLoadModel.lstEquimentAssociate = GetListDataProductsDTH(objModel.strIdSession, objModel.strCustomerId, objModel.strIdContract);
            ...
            {
                Claro.Web.Logging.Error(objModel.strIdSession, "ChangeEquipment", string.Format("ExecuteDTHChangeEquipmentLoad() - Error: {0}", ex.Message));
            }

            return Json(new { data = objChangeEquipmentLoadModel }, JsonRequestBehavior.AllowGet);
        }

        public JsonResult DTHChangeEquipmentLoadModalAssociate()
        {
            var objChangeEquipmentLoadModel = new ChangeEquipmentLoadModel();
        ...
        {
            Claro.Web.Logging.Info(strIdSession, strIdSession, "In GetDecoMatriz - DTH");
            ...
            Claro.Web.Logging.Info(strIdSession, strIdSession, "Out GetDecoMatriz - DTH");
        ...
        {
            Claro.Web.Logging.Info(strIdSession, "ChangeEquipmentDTHChange", "GetMessageObj");
            var objChangeEquipmentMessageModel = new ChangeEquipmentMessageModel
            {
        ...
        public List<HELPERS.LTE.ChangeEquipment.CustomerEquipment> GetListDataProductsDTH(string strIdSession, string CUSTOMER_ID, string CONTRATO_ID)
        {
            ...
            try
            {
                var objServicesLteFixedResponse = Claro.Web.Logging.ExecuteMethod<ServicesLteFixedResponse>(
                    () => _oServiceFixed.GetCustomerEquipmentsDTH(objServicesLteFixedRequest));
        ...
        public JsonResult GetValidateEquipment(ChangeEquipmentValidateModel objModel)
        {
                ...
                if (objModel.strEquipmentTypeCode == ConstantsLTE.strTres)
                {
                    ...
                    if (result[0] == ConstantsLTE.strCero)
                    {
                        ...
                        if (result[0] == ConstantsLTE.strCero)
                        {
                            ...
                            if (result[0] == ConstantsLTE.strCero)
                            {
                                Claro.Web.Logging.Info(objModel.strSessionId, "ChangeEquipment", "EQUIPO DTH");
            ...
            else
            {
                ...
                if (objModel.strEquipmentTypeCode == ConstantsLTE.strTres)
                {
                    Claro.Web.Logging.Info(objModel.strSessionId, "ChangeEquipment", "SIMCARD DTH");
                    result = GetAvailabilitySimcardBSCS(objModel, audit);
                    Claro.Web.Logging.Info(objModel.strSessionId, "ChangeEquipment", "GetAvailabilitySimcardBSCS: " + result[0] + "DESCRIPCION: " + result[1]);
                    if (result[0] == ConstantsLTE.strCero)
                    {
        ...
        private string GetValidateEquipmentTypeAndWeight(ChangeEquipmentValidateModel objRequest, HELPERS.LTE.ChangeEquipment.CustomerEquipment objToAssociate)
        {
            ...
            try
            {
                var arrCombinationDecoByType = GetValueConfig("strCombinacionEquiposPorTipo", objRequest.strSessionId, "DTH-CAMBIO DE EQUIPO-Config").Split(';');
                foreach (var objItem in arrCombinationDecoByType)
                {
                    ...
                    if (strResult == ConstantsLTE.strCero)
                    {
                        ...
                        {
                            var strPermiso = GetValueConfig("strLlavePermisoCambioEquipoDecoTipo", objRequest.strSessionId, "DTH-CAMBIO DE EQUIPO-Config");
        ...
        public JsonResult Save(ChangeEquipmentSaveModel objRequestDataModel)
        {
            ...
            var objChangeEquipmentRequest = new ChangeEquipmentRequest()
            {
                ...
                phone = objRequestDataModel.strNumberTelephone,//KEY.AppSettings("gConstKeyCustomerInteract") + objRequestDataModel.strCustomerID,
                siteobjid = string.Empty,//"770011",//cambiar para no enviar vacio
                ...
                tipoTrans = KEY.AppSettings("strTipTransCambioEquipoDTH"),
                ...
                strSOTAssociate = objRequestDataModel.strCacDac,
            ...
            try
            {
                var objChangeEquipmentResponse = Claro.Web.Logging.ExecuteMethod<ChangeEquipmentResponse>(
                    () => new FixedTransacServiceClient().GetExecuteChangeEquipmentDTH(objChangeEquipmentRequest)
                    );
