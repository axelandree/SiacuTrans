...
namespace Claro.SIACU.Web.WebApplication.Transac.Service.Areas.Transactions.Controllers.LTE
{
    public class SuspensionServiceController : CommonServicesController
    {
        ...
        public ScheduledTransactionHfcModel ProgramTransaction = new ScheduledTransactionHfcModel();

        public ActionResult LteSuspensionService(string mode = "", string tipoServi = "", string estadoServi = "")
        {
            Mode = mode;
        ...
        [HttpPost]
        public JsonResult LteSuspensionService_PageLoad(string strIdSession, string strTransaction, string estadoLinea, string strPermisos, string contractId)
        {
            try
            {
                ...
                var dictionaryPageLoad = new Dictionary<string, object>
                {
                    ...
                    { "chkRetencionVisible", strPermisos.IndexOf(ConfigurationManager.AppSettings("strAccesoChkSuspReactServLTE"), StringComparison.InvariantCultureIgnoreCase) + 1 > 0},
                    //{ "strModoEdicion", string.IsNullOrEmpty(mode)},

                    //IF NOT ISPOSTBACK
                    { "txtMontoRet", ConstantsHFC.PresentationLayer.NumeracionCERO},
                    { "txtTotalImportePagar", ConfigurationManager.AppSettings("MontoCobroReactivacionServicioLTEC")},
        ...
        [HttpPost]
        public JsonResult LteSuspensionService_LoadHiddenMessages(string strIdSession, string strTransaction)
        {
        ...
        [HttpPost]
        public JsonResult LteSuspensionService_LoadInfoCustomer(string strIdSession, string strTransaction)
        {
            ...
            try
            {
                ...
                {
                    { "txtImpPagar", ConfigurationManager.AppSettings("MontoCobroReactivacionServicioLTEC")},
                    { "hidMontoOCC", ConfigurationManager.AppSettings("MontoCobroReactivacionServicioLTEC")},
                    { "hidImportePagar", ConfigurationManager.AppSettings("MontoCobroReactivacionServicioLTEC")},
                    { "hidMontoCobrarUnitario", ConfigurationManager.AppSettings("MontoCobroReactivacionServicioLTEC")},
        ...
        [HttpPost]
        public JsonResult LteSuspensionService_LoadTypification(string strIdSession, string strTransaction)
        {
            var loadTypification = new Dictionary<string, object>();
            try
            {
                var objServiceTypification = GetTypificationHFC(strIdSession, "TRANSACCION_SUSP_REACT_TEMP_LTE");
                var tipo = ConfigurationManager.AppSettings("gConstTipoLTE");
        ...
        public bool LteSuspensionService_VerifyProgramTask(string srtIdSession, string strTransaction, string vstrCoId)
        {
            try
            {
                ...
                //            var viewModelLst = Mapper.Map<List<ScheduledTransactionHfcModel>>(modelLst);
        ...
        [HttpPost]
        public JsonResult LteSuspensionService_LoadDataProgramTask(string strIdSession, string strTransaction, string contractId, string accountNumber)
        {
            ...
            try
            {
                if ((bool)Session["ModoEdicion"])
                {
                    ...
                    var lstProgramTask = LteProgramTask_GetProgramTask(strIdSession, strTransaction, contractId, accountNumber);
                ...
                {
                    if (!LteSuspensionService_VerifyProgramTask(strIdSession, strTransaction, contractId))
                    {
        ...
        public List<ScheduledTransactionHfcModel> LteProgramTask_GetProgramTask(string srtIdSession, string strTransaction, string vstrCoId, string vstrCuenta)
        {
            var viewModelLst = new List<ScheduledTransactionHfcModel>();
            try
            {
                var audit = App_Code.Common.CreateAuditRequest<AuditRequestFixed>(srtIdSession);
                ...
                if (objResponse != null)
                {
                    if (objResponse.ListTransactionScheduled != null)
                    {
                        ...
                        {
                            var modelLst = objResponse.ListTransactionScheduled;
                            viewModelLst = Mapper.Map<List<ScheduledTransactionHfcModel>>(modelLst);
                        }
                    }
                }
            }
        ...
        public void InsertAuditProgTask(string strIdSession, string strTransactionId, string contractId, string monto, string strTexto, string nombreCompleto, string currentUser)
        {
            try
            {
                var strTransaccion = (bool)Session["ModoEdicion"] ? ConfigurationManager.AppSettings("gConstCodigoAuditoriaEditarProgramacionLTE") : ConfigurationManager.AppSettings("strCodTranSuspReactTempLTE");
        ...
        public InteractionModel DataInteraction(string strIdSession, string strIdTransaction, string customerId, string currentUser, string contractId, string codePlanInst, string notes)
        {
            var responseModel = new InteractionModel();
            try
            {
                var objServiceTypification = GetTypificationHFC(strIdSession, "TRANSACCION_SUSP_REACT_TEMP_LTE");
                var tipo = ConfigurationManager.AppSettings("gConstTipoLTE");
        ...
        public TemplateInteractionModel DataTemplateInteraction(string strIdSession, string strIdTransaction, string nroCelular, string fechaSuspension, string fechaReactivacion, string checkRetencion, string contractId, string fullName, string representanteLegal, string tipoDoc, string cuenta, string txtNotas, string txtMontoRet, string nroDoc, string hidImportePagar, string cacDac, string hidTotalImportePagar, string hidMontoCobrarUnitario, string tipoCliente)
        {
            ...
            try
            {
                ...
                responseModel.X_INTER_20 = cuenta;
                responseModel.X_INTER_16 = contractId;
                responseModel.X_INTER_21 = tipoCliente;
        ...
        public Dictionary<string, object> SaveInteraction(string strIdSession, string strIdTransaction, string notes, string customerId, string currentUser, string contractId, string codePlanInst, string nroCelular, string fullName, string socialReason, string representanteLegal, string tipoDoc, string nroDoc, string plan, string cicloFacturacion, string fechaSuspension, string fechaReactivacion, string checkRetencion, string cuenta, string txtMontoRet, string hidImportePagar, string cacDac, string hidTotalImportePagar, string hidMontoCobrarUnitario, string strTypeProduct, string strDateActivation, string strDateEndAcuerdo, string strStatusLine, string tipoCliente)
        {
            ...
            try
            {
                ...
                var oPlantillaDatos = DataTemplateInteraction(strIdSession, strIdTransaction, nroCelular, fechaSuspension, fechaReactivacion, checkRetencion, contractId, fullName, representanteLegal, tipoDoc, cuenta, notes, txtMontoRet, nroDoc, hidImportePagar, cacDac, hidTotalImportePagar, hidMontoCobrarUnitario, tipoCliente);
        ...
        public Dictionary<string, object> ActualizaTransaccionProgramada(string strIdSession, string strIdTransaction, string notes, string customerId, string currentUser, string contractId, string codePlanInst, string nroCelular, string fullName, string socialReason, string representanteLegal, string tipoDoc, string nroDoc, string plan, string cicloFacturacion, string fechaSuspension, string fechaReactivacion, string checkRetencion, string cuenta, string txtMontoRet, string hidImportePagar, string cacDac, string hidTotalImportePagar, string hidMontoCobrarUnitario, string strTypeProduct, string strDateActivation, string strDateEndAcuerdo, string strStatusLine, string tipoCliente)
        {
            ...
            try
            {
                if (idInteract.Length > 0)
                {
                    ...
                    {
                        UpdateXInter29(strIdSession, idInteract, FunctionsSIACU.GetValueFromConfigFile("strMensajeErrorEnTranActNota", ConfigurationManager.AppSettings("strConstArchivoSIACUTHFCConfigMsg")), string.Empty);
                        dictionaryResponse["lblMensajeVisible"] = true;
        ...
        public Model.HFC.SuspensionModel SuspenderServicio(string strIdSession, string strIdTransaction, string strCodId, DateTime dtFechaSuspension, int intDias, string strCodAplic, string strPasswordAplic, string interaccion, string customerId, string contractId, string chkRetencion, string accountNumber, string currentUser)
        {
            ...
            var objRequest = new PostSuspensionLteRequest
            {
                audit = objAuditRequest
            };

            var objSuspension = new SuspensionLte
            {
            ...
            objSuspension.flagAccion = Convert.ToInt(FunctionsSIACU.GetValueFromConfigFile("gConstFlagAccSusRetTempo", ConfigurationManager.AppSettings("strConstArchivoSIACUTHFCConfig")));
            ...
            var objSuspensionResponse = Logging.ExecuteMethod(() => _oServiceFixed.EjecutaSuspensionDeServicioLte(objRequest));

            objResponse.ResultMethod = objSuspensionResponse.ResponseStatus;
            ...
            string strIdSession)
        {
            ...
            try
            {
                ...
                var objRequest = new ReconexionLteRequest
                {
                    audit = objAuditRequest
                    
                };

                var objRec = new ReconexionLte();
                objRec.codigoAplicacion = strCodAplic;
                objRec.ipAplicacion = strIpAplication;
                objRec.flagAccion = Convert.ToInt(FunctionsSIACU.GetValueFromConfigFile("gConstFlagAccSusRetTempo", ConfigurationManager.AppSettings("strConstArchivoSIACUTHFCConfig")));

                objRec.fechaProgramacion = dtDatReactivation;
                objRec.coId = strCodId;
                objRec.reason = FunctionsSIACU.GetValueFromConfigFile("gConstReasonReconexion", ConfigurationManager.AppSettings("strConstArchivoSIACUTHFCConfigMsg"));
                objRec.coState = FunctionsSIACU.GetValueFromConfigFile("gConstCoStateReconexion", ConfigurationManager.AppSettings("strConstArchivoSIACUTHFCConfigMsg"));
                objRec.codCliente = strCustomerId;
                if (retencion.Equals("1"))
                {
                    objRec.montoOCC = Math.Round(totalPagar, 2);
                }
                else
                {
                    if (!string.IsNullOrEmpty(txtImporteAPagar))
                    {
                        objRec.montoOCC = Single.Parse(txtImporteAPagar);
                    }
                    else
                    {
                        objRec.montoOCC = Single.Parse(hdnImpAPagar);
                    }
                }

                objRec.interaccion = interaccion;
                objRec.telefono = string.Empty;
                objRec.tipoServicio = string.Empty;
                objRec.coSer = string.Empty;
                objRec.tipoRegistro = string.Empty;
                objRec.usuarioSistema = ConfigurationManager.AppSettings("USRProcesoSU");
                objRec.usuarioApp = strUser;
                objRec.emailUsuarioApp = string.Empty;
                objRec.desCoSer = string.Empty;
                objRec.codigoInteraccion = interaccion;
                objRec.nroCuenta = strAcount;
                objRec.ticklerCode = ConfigurationManager.AppSettings("gConstTicklerNormalSS");

                ReconexionLteResponse objResponse = null;
                //var audit = App_Code.Common.CreateAuditRequest<AuditRequestFixed>(strIdSession);
                //objRec.audit = audit;
                objRequest.ReconexionLte = objRec;
                try
                {
                    objResponse = Logging.ExecuteMethod(() =>
                    {
                        return _oServiceFixed.EjecutaReconexionDeServicioLte(objRequest);
                    });
                }
                catch (Exception ex)
                {
                ...
                dictionary["BoolResult"] = objResponse.ResponseStatus;
                dictionary["IdTransaction"] = string.Empty;
                dictionary["Result"] = objResponse.ResponseStatus;
            }
            catch (Exception e)
            {
        ...
        public bool EditarTareasProgramadas(string strIdSession, string strIdTransaction, string strCodId, DateTime dtFechaProgramacion, string currentUser)
        {
            ...
            try
            {
                ...
                var objRequest = new UpdateProgTaskLteRequest
                {
                    audit = objAuditRequest,
                    ...
                    ConId = strCodId,
                    ServiEstado = ConstantsHFC.PresentationLayer.NumeracionCUATRO,
                    FechaProg = dtFechaProgramacion.ToString("yyyy-MM-dd")
                };

                var objResponse = Logging.ExecuteMethod(() =>
                {
                    return _oServiceFixed.UpdateProgTaskLte(objRequest);
                });

                if (objResponse != null)
                {
                    responseBoolean = objResponse.ResultStatus;
                }
            }
            catch (Exception ex)
            {
                LogException(strIdSession, strIdTransaction, "EditarTareasProgramadas", ex);
                throw;
            }
