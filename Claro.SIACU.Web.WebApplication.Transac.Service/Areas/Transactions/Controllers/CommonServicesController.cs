            ...
            OrderTypesRequestHfc objOrderTypesRequest = new OrderTypesRequestHfc()
    {
        ...
        public JsonResult HfcGetAdditionalServices(string strCoId)
        {
            ...
            try
            {
                ...
                //INC000004211915//
                Logging.Info(objAuditRequest.Session, "HfcGetAdditionalServices: ", "GetAdditionalServices() - lstCommertialServices.count: " + lstCommertialServices.Count);
                Logging.Info(objAuditRequest.Session, "HfcGetAdditionalServices: ", "GetCommertialPlan() - strCommertialPlan: " + strCommertialPlan);
                Logging.Info(objAuditRequest.Session, "HfcGetAdditionalServices: ", "GetRetServicesByPlan() - lstRetentionServices.count: " + lstRetentionServices.Count);
