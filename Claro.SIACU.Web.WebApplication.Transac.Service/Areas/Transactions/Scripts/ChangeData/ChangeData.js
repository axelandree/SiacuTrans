...
function fillTipDOcRRLL(oValor, combo) {
    
    $.app.ajax({
        type: "POST",
        url: "/Transactions/Postpaid/ChangeData/GetTypeDocumentTOBE",
        data: {
            strIdSession: "20210430152623"
        },
        success: function (response) {
            ...
            if (itemSelect !== null && itemSelect.toString !== "undefined") {
                $("#" + combo + " option[value=" + itemSelect + "]").attr("selected", true);
                //that.cboTD1_change();
            }
            $("#" + combo + " option[value='6']").remove();
        }
    });
}

function setDataRRLL() {
    
        $("#divRRLL").css("display", "");
        var objRegRL = {};
        var objTotReg = 0;
        objRegRL = SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal;
        $("#hidflagrl").val(SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal.length)
        ...
        switch (objTotReg) {
            case 1:
                $('#txtAP1').val(((objRegRL[0].cuRepapepat !== null) || (objRegRL[0].cuRepapepat !== undefined)) ? objRegRL[0].cuRepapepat : "");
                $('#txtAM1').val(((objRegRL[0].cuRepapemat !== null) || (objRegRL[0].cuRepapemat !== undefined)) ? objRegRL[0].cuRepapemat : "");
                $('#txtN1').val(((objRegRL[0].cuRepnombres !== null) || (objRegRL[0].cuRepnombres !== undefined)) ? objRegRL[0].cuRepnombres : "");
                $('#txtND1').val(((objRegRL[0].cuRepnumdoc !== null) || (objRegRL[0].cuRepnumdoc !== undefined)) ? objRegRL[0].cuRepnumdoc : "");
                fillTipDOcRRLL(parseInt(objRegRL[0].cuReptipdoc), "cboTD1");
                break;
            case 2:
                $('#txtAP1').val(((objRegRL[0].cuRepapepat !== null) || (objRegRL[0].cuRepapepat !== undefined)) ? objRegRL[0].cuRepapepat : "");
                $('#txtAM1').val(((objRegRL[0].cuRepapemat !== null) || (objRegRL[0].cuRepapemat !== undefined)) ? objRegRL[0].cuRepapemat : "");
                ...
                $('#txtAP2').val(((objRegRL[1].cuRepapepat !== null) || (objRegRL[1].cuRepapepat !== undefined)) ? objRegRL[1].cuRepapepat : "");
                $('#txtAM2').val(((objRegRL[1].cuRepapemat !== null) || (objRegRL[1].cuRepapemat !== undefined)) ? objRegRL[1].cuRepapemat : "");
                $('#txtN2').val(((objRegRL[1].cuRepnombres !== null) || (objRegRL[1].cuRepnombres !== undefined)) ? objRegRL[1].cuRepnombres : "");
                $('#txtND2').val(((objRegRL[1].cuRepnumdoc !== null) || (objRegRL[1].cuRepnumdoc !== undefined)) ? objRegRL[1].cuRepnumdoc : "");             
                fillTipDOcRRLL(parseInt(objRegRL[1].cuReptipdoc), "cboTD2");
                break;
            case 3:
                $('#txtAP1').val(((objRegRL[0].cuRepapepat !== null) || (objRegRL[0].cuRepapepat !== undefined)) ? objRegRL[0].cuRepapepat : "");
                $('#txtAM1').val(((objRegRL[0].cuRepapemat !== null) || (objRegRL[0].cuRepapemat !== undefined)) ? objRegRL[0].cuRepapemat : "");
                ...
                $('#txtAP3').val(((objRegRL[2].cuRepapepat !== null) || (objRegRL[2].cuRepapepat !== undefined)) ? objRegRL[2].cuRepapepat : "");
                $('#txtAM3').val(((objRegRL[2].cuRepapemat !== null) || (objRegRL[2].cuRepapemat !== undefined)) ? objRegRL[2].cuRepapemat : "");
                $('#txtN3').val(((objRegRL[2].cuRepnombres !== null) || (objRegRL[2].cuRepnombres !== undefined)) ? objRegRL[2].cuRepnombres : "");
                $('#txtND3').val(((objRegRL[2].cuRepnumdoc !== null) || (objRegRL[2].cuRepnumdoc !== undefined)) ? objRegRL[2].cuRepnumdoc : "");
                fillTipDOcRRLL(parseInt(objRegRL[2].cuReptipdoc), "cboTD3");                
                break;
            case 4:
                $('#txtAP1').val(((objRegRL[0].cuRepapepat !== null) || (objRegRL[0].cuRepapepat !== undefined)) ? objRegRL[0].cuRepapepat : "");
                $('#txtAM1').val(((objRegRL[0].cuRepapemat !== null) || (objRegRL[0].cuRepapemat !== undefined)) ? objRegRL[0].cuRepapemat : "");
                ...
                $('#txtAP4').val(((objRegRL[3].cuRepapepat !== null) || (objRegRL[3].cuRepapepat !== undefined)) ? objRegRL[3].cuRepapepat : "");
                $('#txtAM4').val(((objRegRL[3].cuRepapemat !== null) || (objRegRL[3].cuRepapemat !== undefined)) ? objRegRL[3].cuRepapemat : "");
                $('#txtN4').val(((objRegRL[3].cuRepnombres !== null) || (objRegRL[3].cuRepnombres !== undefined)) ? objRegRL[3].cuRepnombres : "");
                $('#txtND4').val(((objRegRL[3].cuRepnumdoc !== null) || (objRegRL[3].cuRepnumdoc !== undefined)) ? objRegRL[3].cuRepnumdoc : "");
                fillTipDOcRRLL(parseInt(objRegRL[3].cuReptipdoc), "cboTD4");
                break;
            case 5:
                $('#txtAP1').val(((objRegRL[0].cuRepapepat !== null) || (objRegRL[0].cuRepapepat !== undefined)) ? objRegRL[0].cuRepapepat : "");
                $('#txtAM1').val(((objRegRL[0].cuRepapemat !== null) || (objRegRL[0].cuRepapemat !== undefined)) ? objRegRL[0].cuRepapemat : "");
                ...
                $('#txtAP5').val(((objRegRL[4].cuRepapepat !== null) || (objRegRL[4].cuRepapepat !== undefined)) ? objRegRL[4].cuRepapepat : "");
                $('#txtAM5').val(((objRegRL[4].cuRepapemat !== null) || (objRegRL[4].cuRepapemat !== undefined)) ? objRegRL[4].cuRepapemat : "");
                $('#txtN5').val(((objRegRL[4].cuRepnombres !== null) || (objRegRL[4].cuRepnombres !== undefined)) ? objRegRL[4].cuRepnombres : "");
                $('#txtND5').val(((objRegRL[4].cuRepnumdoc !== null) || (objRegRL[4].cuRepnumdoc !== undefined)) ? objRegRL[4].cuRepnumdoc : "");
                fillTipDOcRRLL(parseInt(objRegRL[3].cuReptipdoc), "cboTD5");
                break;
        }
}

function showHideRRll() {
    var listaRL = {};
    var totReg = 0;
    var objSessions = {}
        ...
        if (SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal !== null) {
            ...
            switch (totReg) {
                case 1:
                    ...
                    document.getElementById('divRLC').style.display = "block";
                    $("#hidflagrl").val(1);
                    break;
                case 2:
                    document.getElementById("divRL1").style.display = "";
...
function ObtenerListaRRLL(nroDocu) {
    
    //if (SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal == undefined || SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal == null) {
            $.app.ajax({
                    type: 'POST',
                    cache: false,
                    async: false,
                    ...
                    data: JSON.stringify({
                        strNumDocumento: nroDocu,
                        strTipoDocumento: $("#cboTipDoc").val(),
                        strIdSession: SessionTransf.IDSESSION
                    }),
                    url: '/Transactions/Postpaid/ChangeData/DataRepreLegal',
                    success: function (response) {
                        ...
                        if (lendata > 0) {
                            ...
                            SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal = []
                            $.each(response.data, function (index, value) {
                                SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal.push(value);
                            });
                            ...
                            $("#hidflagrl").val(0)
                            SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal = null;
                            SessionTransf.listaRL = undefined;
                            document.getElementById("divRRLL").style.display = 'none';
                            document.getElementById("NuevosDatos").style.display = 'block';
                        }
                    }
                });
        //}
                ...
                if (opcion == "RUC") {
                    if ($(this).val().length == 10) {
                        ...
                        if (ValidDoc == 'X') {
                            ...
                            if ($("#hidPlataform").val() == 'TOBE') {
                                var valorenddigit = 0;

                                var lista = ['`', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i']
                                var valueKey = String.fromCharCode(event.keyCode)
                                console.log(valueKey)
                                var esnumero = isNaN(valueKey);
                                console.log(esnumero)
                                if (esnumero) {
                                    console.log(lista.indexOf(valueKey));
                                    valorenddigit = lista.indexOf(valueKey);
                                } else {
                                    valorenddigit = valueKey;
                                    console.log(valorenddigit);
                                }
                                console.log(String.fromCharCode(event.which), String.fromCharCode(event.keyCode), valorenddigit)
                                console.log($(this).val() + valorenddigit)
                                ObtenerListaRRLL($(this).val() + valorenddigit);
                            }

                            $('#divNameCli').css("display", "none");
                            $('#divNameC').css("display", "block");
                            if ($("#hidPlataform").val() == 'TOBE') {
                                $('#divApeTobe').css('display', 'none');
                                $('.cltobe').css('display', 'none');
                                if (SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal != undefined || SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal != null) {
                                    $('#divRRLL').css('display', 'block');
                                } else {
                        ...
                        if (ValidDoc == '10') {
                            if ($("#hidPlataform").val() == 'TOBE') {
                                $('#divApeTobe').css('display', 'block');
                                $('.cltobe').css('display', 'block');
                                $('#divRRLL').css('display', 'none');
                            }
...
(function ($, undefined) {
    ...
    $("#hidPlataform").val(SessionTransf.plataformaAT);
...
var msgConfirmacion="¿Seguro que desea guardar la transacción?";
            ...
            if (opcion !== 'RUC') {
                ...
                if (tpDoc == '10') {
                    ...
                    that.modelChangeData.strNombreComercialNew = $('#txtNameComChangeData').val();
                }
            ...
            //-----------------------------------------------------------
            var primero = function (segundo) 
            {
                if (SessionTransac.SessionParams.DATACUSTOMER.objPostDataAccount.plataformaAT == "ASIS") { segundo(); }
            ...
            confirm(msgConfirmacion, 'Confirmar', function () {
                ...
                if ((SessionTransf !== null) && (SessionTransf.listaRL !== undefined)) {
                    ...
                    that.modelChangeData.rrllHistorico = JSON.stringify(SessionTransac.SessionParams.DATACUSTOMER.listaRepresentanteLegal);

                } else {
                    that.modelChangeData.listaRL = "";
                    that.modelChangeData.listaRLOLD = "";
                    that.modelChangeData.rrllHistorico = "";
                }
        ...
        cboTipDoc_change: function () {
            ...
            if (opcion == 'RUC') {
                ...
                if ($("#hidPlataform").val() == 'TOBE') {
                    if (!valid) $('#divApeTobe').css('display', 'none');
                }
