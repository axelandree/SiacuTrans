...
(function ($, undefined) {
    ...
    var Form = function ($element, options) {
        $.extend(this, $.fn.INTNetflixServicePostpaid.defaults, $element.data(), typeof options === 'object' && options);
        this.setControls({
            form: $element
            ...
            , txtEmailConstancia: $('#txtEmailConstancia', $element)
    ...
    Form.prototype = {
        ...
        loadCustomerData: function () {
            ...
            //********** Datos del Cliente ***********/
            controls.txtLinea.val((Session.CLIENTE.Telephone == null) ? '' : Session.CLIENTE.Telephone);
            ...
            var obj = {
                ...
                intCoId: Session.LINEA.ContractID,
                strPlataforma: Session.LINEA.CodePlanTariff.indexOf("One") > -1 ? "TOBE" : "ASIS",
                strServicioOne: Session.LINEA.CodePlanTariff,
                strPhone: Session.CLIENTE.Telephone
            };
            ...
            $.app.ajax({
                ...
                url: '/Transactions/Postpaid/NetflixServices/validaServicioContratado',
        ...
        saveTransactionSendRegister: function () {
            ...
            $.app.ajax({
                ...
                url: '/Transactions/Postpaid/NetflixServices/saveTransactionNetflixServices',
                error: function (response) {
                    alert(response.data);
                },
                success: function (response) {
        ...
        IniTypification: function () {
            ...
            $.app.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                data: JSON.stringify(obj),
                url: '/Transactions/Postpaid/NetflixServices/PageLoad',
                success: function (response) {
                    if (response.data != null) {
    ...
    $.fn.INTNetflixServicePostpaid = function () {
        ...
        this.each(function () {
            var $this = $(this),
                data = $this.data('INTNetflixServicePostpaid'),
                options = $.extend({}, $.fn.INTNetflixServicePostpaid.defaults,
                    $this.data(), typeof option === 'object' && option);

            if (!data) {
                data = new Form($this, options);
                $this.data('INTNetflixServicePostpaid', data);
            }
    ...
    $.fn.INTNetflixServicePostpaid.defaults = {
    }

    $('#divBody').INTNetflixServicePostpaid();
})(jQuery);