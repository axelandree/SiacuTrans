    ...
    Form.prototype = {
        ...
        loadConfigVariables: function () {
            ...
            $.app.ajax({
                ...
                success: function (response) {
                    that.strLTECambioNumeroCostoTrans = response[0];
                    that.strLTECambioNumeroCostoLocucion = response[1];
                    ...
                    controls.txtTransacCost.val(that.strLTECambioNumeroCostoTrans);
                    controls.txtLocutionCost.val(that.strLTECambioNumeroCostoLocucion);
            ...
            $.app.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.data != null) {
                        var CostNoIGV = that.strLTECambioNumeroCostoTrans;
                        var CostLocNoIGV = that.strLTECambioNumeroCostoLocucion;
                        var igv = parseFloat(response.data.igvD) + 1.00;
                        that.strLTECambioNumeroCostoTransSinIGV = (parseFloat(CostNoIGV) / parseFloat(igv)).toFixed(2);
                        that.strLTECambioNumeroCostoLocucionSinIGV = (parseFloat(CostLocNoIGV) / parseFloat(igv)).toFixed(2);
        ...
        getNewPhoneNumber: function () {
            ...
            if (controls.chkFidelizeTransac.prop('checked')) {
                ...
                objChangeNumber.COST_TRANS = that.strLTECambioNumeroCostoTransSinIGV;
            ...
            if (controls.chkLocution.prop('checked')) {
                ...
                if (controls.chkLocutionFidelize.prop('checked')) {
                    ...
                    objChangeNumber.COST_LOCU = that.strLTECambioNumeroCostoLocucionSinIGV;
        ...
        strLTECambioNumeroCostoTrans: '',
        strLTECambioNumeroCostoTransSinIGV: '',
        strLTECambioNumeroCostoLocucion: '',
        strLTECambioNumeroCostoLocucionSinIGV: '',
