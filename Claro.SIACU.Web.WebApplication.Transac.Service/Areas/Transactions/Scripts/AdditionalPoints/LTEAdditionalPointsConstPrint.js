(function ($, undefined) {
    ...
    var Form = function ($element, options) {
        ...
        $.extend(this, $.fn.ETLAdditionalPointsConstPrint.defaults, $element.data(), typeof options === 'object' && options);
    ...
    Form.prototype = {
        ...
        f_Load: function () {
            ...
            strUrl = "/Transactions/LTE/AdditionalPoints/LoadConstPrint";
            $.app.ajax({
                type: 'POST',
    ...
    $.fn.ETLAdditionalPointsConstPrint = function () {
        ...
        this.each(function () {
            ...
            var $this = $(this),
                data = $this.data('ETLAdditionalPointsConstPrint'),
                options = $.extend({}, $.fn.ETLAdditionalPointsConstPrint.defaults,
                    $this.data(), typeof option === 'object' && option);

            if (!data) {
                data = new Form($this, options);
                $this.data('ETLAdditionalPointsConstPrint', data);
            }
    ...
    $.fn.ETLAdditionalPointsConstPrint.defaults = {
    }

    $('#divBody').ETLAdditionalPointsConstPrint();
})(jQuery);
