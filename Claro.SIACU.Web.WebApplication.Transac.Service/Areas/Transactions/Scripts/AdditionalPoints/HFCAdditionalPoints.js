...
(function ($, undefined) {
    ...
    //URL
    var URL_GetJobType = window.location.protocol + '//' + window.location.host + '/Transactions/HFC/AdditionalPoints/GetJobType';
    ...
    var URL_GetDocumentType = window.location.protocol + '//' + window.location.host + '/Transactions/HFC/AdditionalPoints/GetDocumentType';
    var URL_GetAttachedQuantity = window.location.protocol + '//' + window.location.host + '/Transactions/HFC/AdditionalPoints/GetAttachedQuantity';
    ...
    var URL_GetParameter = window.location.protocol + '//' + window.location.host + '/Transactions/HFC/AdditionalPoints/GetParameter';
    var URL_GetProductDetailt = window.location.protocol + '//' + window.location.host + '/Transactions/HFC/AdditionalPoints/GetProductDetailt';
    var URL_AdditionalPointsSave = window.location.protocol + '//' + window.location.host + "/Transactions/HFC/AdditionalPoints/AdditionalPointsSave";
    var URL_GetConsultIGV = window.location.protocol + '//' + window.location.host + '/Transactions/CommonServices/GetConsultIGV';
    var URL_Constancy = window.location.protocol + '//' + window.location.host + '/Transactions/HFC/AdditionalPoints/HFCAdditionalPointsConstPrint';

    var URL_Constancy_PDF = window.location.protocol + '//' + window.location.host + "/Transactions/HFC/AdditionalPoints/GenerateContancy";
    //Model
    ...
    AdditionalPointsModel.strMessageValiateMail = "";
    ...
    var Form = function ($element, options) {
        ...
        $.extend(this, $.fn.HFCAdditionalPoints.defaults, $element.data(), typeof options === 'object' && options);
    ...
    Form.prototype = {
        ...
        init: function () {
            var that = this,
                ...
                controls.cboServicesType.addEvent(that, 'change', that.cboServicesType_Change);
        ...
        f_GetDataSession: function () {
            ...
            controls.spnMainTitle.text("PUNTO ADICIONAL - HFC");
            ...
            Session.codOpcion = "srtCodOpcionPuntosAdicionalesHFC";
        ...
        f_Initial: function () {
            var that = this,
             ...
             oCustomer = Session.DATACUSTOMER,
             oUserAccess = Session.USERACCESS,
             oDataService = Session.DATASERVICE;// oDatLine = Session.DATLINE;
            ...
            $.app.ajax({
                ...
                success: function (response) {
                    if (response != null) {
                        ...
                        AdditionalPointsModel.strCableValue = oDataService.CableValue;

                        if ($.trim(response.strJobTypeComplementarySalesHFC) == "") { response.strJobTypeComplementarySalesHFC = 700; }
                        AdditionalPointsModel.strJobTypeComplementarySalesHFC =
                            response.strJobTypeComplementarySalesHFC;
                        ...
                        AdditionalPointsModel.strMessageConfirmAdditionsPoints =
                            response.strMessageConfirmAdditionsPoints;
                        AdditionalPointsModel.strMessageEnterMail = response.strMessageEnterMail;
                        AdditionalPointsModel.strMessageValiateMail = response.strMessageValiateMail;
                        ...
                        AdditionalPointsModel.strMessageConsultationDisabilityNotAvailable =
                            response.strMessageConsultationDisabilityNotAvailable;
                        ...
                        that.strAdditionalPointHFCCosto = response.strAdditionaPointHFCCost;
                        ...
                        if (strPlano.search(strPlanoFTTH) > 0 && response.strMensajeTransaccionFTTH != '') {
                            alert(response.strMensajeTransaccionFTTH.replace('{0}', "PUNTOS ADICIONALES"), "Alerta", function () {
                                parent.window.close();
                            });
                            return false;
                        }
        ...
        btnSave_Click: function () {
            ...
            if (that.f_ValidateMail()) {
                if ($.isNumeric(controls.txt_phone_references.val()) || controls.txt_phone_references.val() == "") {
                    ...
                    if (controls.cboJobTypes.val() == "480.|" || controls.cboJobTypes.val() == AdditionalPointsModel.strJobTypeComplementarySalesHFC) {
                        if (controls.cboServicesType.val() == "" || controls.cboServicesType.val() == "-1") {
                            alert("Necesita seleccionar un tipo de servicio.", "Alerta");
                            return false;
                        }
                        if (controls.cboJobTypes.val() == AdditionalPointsModel.strJobTypeComplementarySalesHFC && controls.cboAttachedQuantity.val() == "-1") {
                    ...
                    confirm(AdditionalPointsModel.strMessageConfirmAdditionsPoints, 'Confirmar', function (result) {
                        if (result == true) {
                            ...
                            model.strTransaction = "TRANSACCION_GEN_ORD_VISITA_MANT_HFC";
                            model.strTelephone = oCustomer.PhoneContact;
                            model.strNote = controls.txtNote.val();
                            model.strEmail = controls.txt_SendMail.val();
                            model.strCodeTipification = "TRANSACCION_GEN_ORD_VISITA_MANT_HFC";
                            model.strModality = 'Modality';
                            ...
                            model.strPostalCode = oCustomer.PlaneCodeInstallation;
                                    ...
                                    if (response != null) {
                                        if (!response.bErrorTransac) {
                                            ...
                                            if (!response.bErrorGenericCodSot) {
                                                ...
                                                controls.lblHCFNroSot.text(response.strCodSOT);
                                                alert(AdditionalPointsModel.strMessageOK, "Informativo");
                                            }
                                            else {
                                                alert("Hubo un problema al generar el código SOT.", "Alerta");
                                            }
        ...
        cboJobTypes_Change : function(){
            ...
            //controls.txt_dDateProgramming.val("");
            ...
            if (controls.cboJobTypes.val() == "480.|" || controls.cboJobTypes.val() == AdditionalPointsModel.strJobTypeComplementarySalesHFC) {
                ...
                model.strJobTypes = AdditionalPointsModel.strJobTypeComplementarySalesHFC; //controls.cboJobTypes.val();
                ...
                if (controls.cboJobTypes.val() == AdditionalPointsModel.strJobTypeComplementarySalesHFC) {
        ...
        cboServicesType_Change: function () {
            var that = this,
                   controls = that.getControls();
            var validateEta = Session.ValidateETA;
            if (validateEta != '0')
            {
                if (controls.cboServicesType.val() == "1") {
                    controls.cboSubJobTypes.val($('#cboSubJobTypes option').eq(2).val());
                }
                else if (controls.cboServicesType.val() == "2") {
                    controls.cboSubJobTypes.val($('#cboSubJobTypes option').eq(1).val());
                } else {
                    controls.cboSubJobTypes.val($('#cboSubJobTypes option').eq(0).val());
                }
            }
        },
        ...
        f_ValidacionETA: function () {
            ...
            model.IdSession = Session.IDSESSION;
            model.strJobTypes = controls.cboJobTypes.val();
            model.strCodePlanInst = controls.lblCodePlans.text();
        ...
        strAdditionalPointHFCCosto: ''
    };


    $.fn.HFCAdditionalPoints = function () {
        ...
        this.each(function () {
            ...
            var $this = $(this),
                data = $this.data('HFCAdditionalPoints'),
                options = $.extend({}, $.fn.HFCAdditionalPoints.defaults,
                    $this.data(), typeof option === 'object' && option);

            if (!data) {
                data = new Form($this, options);
                $this.data('HFCAdditionalPoints', data);
            }
    ...
    $.fn.HFCAdditionalPoints.defaults = {
    }

    $('#divBody').HFCAdditionalPoints();
