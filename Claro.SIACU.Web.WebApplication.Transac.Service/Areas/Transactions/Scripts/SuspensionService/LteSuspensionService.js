...
function restaMontos() {
    ...
    try {
        ...
        if (v1 > v2) {
            alert("El monto de la retenciónn no puede ser mayor al importe a pagar.", "Alerta");
...
function saveSuspension(pag, controls) {
    ...
    confirm(sessionTransac.HiddensTransact.hdnMensaje1, 'Confirmar', function () {
        ...
        // string strTypeProduct, string strDateActivation, string strDateEndAcuerdo, string strStatusLine, string tipoCliente
        var param = {
            ...
            tipoCliente: sessionTransac.DATACUSTOMER.CustomerType
        };
...
function f_Imprimir() {
    alert("Generar constancia.", "Alerta");
    //var w = 1005;
    //var h = 650;
    ...
    //var strIdInteraccion = $("#hdnInteracId").val();
    //if (document.getElementById("hidFlagContingenciaHP").value == '1') {
    //    var rutaPDF = document.getElementById("hidRutaPDF").value;
    //    if (rutaPDF == "FALLO" || rutaPDF == "") {
    //        alert("No se generó Constancia ó No tiene Acceso para verla.");
    //    } else {
    //        window.open("HFCPOST_xMostrarPDF.aspx?strRutaPdf=" + rutaPDF, "", opciones);
    //    }
    //} else {
    //    window.open("HFCPOST_Suspension_Servicio_Imp.aspx?IdInteraccion=" + strIdInteraccion, "", opciones);
    //}
};
...
(function ($) {
    ...
    Form.prototype = {
        ...
        PageLoadSuspensionService: function () {
            ...
            var strUrlController = that.strUrl + '/SuspensionService/LteSuspensionService_PageLoad';
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.EstadoLinea != "") {
                        alert(response.EstadoLinea, "Informativo");
                        parent.window.close();
                        return;
                    }
        ...
        LoadHiddenMessages: function () {
            ...
            var strUrlController = that.strUrl + '/SuspensionService/LteSuspensionService_LoadHiddenMessages';
        ...
        LoadInfoCustomer: function () {
            ...
            var strUrlController = that.strUrl + '/SuspensionService/LteSuspensionService_LoadInfoCustomer';
            var param = { "strIdSession": Session.IDSESSION, "strTransaction": Session.IDSESSION }
        ...
        LoadTypification: function () {
            ...
            var strUrlController = that.strUrl + '/SuspensionService/LteSuspensionService_LoadTypification';
            ...
            $.app.ajax({
                ...
                success: function (response) {
                    if (response.lblMensajeVis) {
                        alert(response.lblMensajeTxt, "Informativo");
        ...
        LoadDataProgramTask: function () {
            ...
            var strUrlController = that.strUrl + '/SuspensionService/LteSuspensionService_LoadDataProgramTask';
                ...
                success: function (response) {
                    ...
                    if (sessionTransac.HiddensTransact.ModoEdicion) {
                        ...
                        if (response.gConstMsgLineaPOTPVisble) {
                            alert(response.gConstMsgLineaPOTP, "Informativo", function () {
                                parent.window.close();
                            });
                            return;
                        }
        ...
        strUrl: window.location.protocol + '//' + window.location.host + '/Transactions/LTE/'
    };
