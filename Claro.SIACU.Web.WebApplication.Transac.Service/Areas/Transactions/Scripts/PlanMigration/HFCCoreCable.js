...
(function ($, undefined) {
    ...
    var Form = function ($element, options) {
        ...
        $.extend(this, $.fn.CoreCable.defaults, $element.data(), typeof options === 'object' && options);

        this.setControls({
            form: $element
            , tblCoreCable: $('#tblCoreCable', $element)
        });
    ...
    Form.prototype = {
        ...
        getLoadDetailVisualizeCall: function () {
            ...
            controls.tblCoreCable.DataTable({
    ...
    $.fn.CoreCable = function () {
        ...
        this.each(function () {
            ...
            var $this = $(this),
                data = $this.data('CoreCable'),
                options = $.extend({}, $.fn.CoreCable.defaults,
                    $this.data(), typeof option === 'object' && option);

            if (!data) {
                data = new Form($this, options);
                $this.data('CoreCable', data);
            }
