...
{
    public class ChangeEquipmentSaveModel
    {
        ...
        public List<Helpers.LTE.ChangeEquipment.CustomerEquipment> lstEquimentsAssociate { get; set; }
        ...
        public string strSOTAsociateCode { get; set; }
        public string strSOTAsociate { get; set; }
        //Response Save
    ...
    public class ChangeEquipmentMessageModel
    {
        ...
        public string strMsgCheckFullChange { get; set; }
        ...
        public string strValidateCombinationDecoType { get; set; }
        public string strValidateWeightDecoType { get; set; }
        public string strValidateSOTAssociate { get; set; }
    }

    public class ChangeEquipmentValidateModel
    {
        public string strSessionId { get; set; }
        ...
        public Helpers.LTE.ChangeEquipment.CustomerEquipment objEquipmentToAssociate { get; set; }
        public List<Helpers.LTE.ChangeEquipment.CustomerEquipment> lstEquimentAssociate { get; set; }
        public List<Helpers.LTE.ChangeEquipment.CustomerEquipment> lstEquimentsAssociateSummary { get; set; }
        public List<DecoMatriz> lstWeight { get; set; }
        public string strDecosMax { get; set; }
        public string strOldEquipmentSeriesDeco { get; set; }
        
    }

    public class ChangeEquipmentLoadModel
    {
        public string strIdSession { get; set; }
        public string strCodeUser { get; set; }
        public string strMessage { get; set; }
        public ChangeEquipmentMessageModel objChangeEquipmentMessageModel { get; set; }
        ...
        public string strActiveFullChangeEquipmentForLTE { get; set; }
        ...
        // Objetos a cambiar y agregar para el Método **ExecuteChangeEquipment
