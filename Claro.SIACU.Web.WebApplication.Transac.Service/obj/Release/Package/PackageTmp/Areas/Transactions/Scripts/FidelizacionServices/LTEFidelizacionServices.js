(function ($, undefined) {
    ...
    var Form = function ($element, options) {
        $.extend(this, $.fn.LTEFidelizacionServices.defaults, $element.data(), typeof options === 'object' && options);
        this.setControls({
            form: $element
            // Hidden
    ...
    Form.prototype = {
        ...
        InitGetMessage: function () {
            ...
            $.app.ajax({
                ...
                url: '/Transactions/LTE/FidelizacionServices/GetMessage',
                success: function (response) {
                    if (response != null) {
                        ...
                        SessionTransf.gConstMsgDescuentoActivo = response[31];
                        SessionTransf.strMsjCantidadLimiteDecos = response[32];
                        SessionTransf.ServiceType = response[33];
        ...
        loadCustomerData: function () {
            ...
            Session.CodUbigeo = (SessionTransac.SessionParams.DATACUSTOMER.InstallUbigeo == null) ? "" : SessionTransac.SessionParams.DATACUSTOMER.InstallUbigeo;
            CodUbigeoAux = (SessionTransac.SessionParams.DATACUSTOMER.InstallUbigeo == null) ? "" : SessionTransac.SessionParams.DATACUSTOMER.InstallUbigeo;
            ...
            Session.DATACUSTOMER =
            {
                ...
                CodeCenterPopulate: Session.CLIENTE.CodeCenterPopulate
                //#endregion
            };
        ...
        SaveTransactionFidelizacion: function () {
            ...
            if (SessionTransf.idAccion == strIdCargoFijo) {
                ...
                model.costoServicioconIGV = SessionTransf.strTarifRet;
            ...
            if (SessionTransf.isDecodificator) {
                ...
                {//
                    ...
                    InsInteractionPlusModel: {
                        ...
                        Inter20: Session.CLIENTE.CodeCenterPopulate,//.PlaneCodeInstallation,
                        Inter21: 1,//cantidad
                ...
                strUrl = '/Transactions/LTE/FidelizacionServices/SaveTransactionRetentionDeco';
            }
            else {
                strUrl = '/Transactions/LTE/FidelizacionServices/SaveTransactionFidelizacion';
            }
           ...
           controls = that.getControls(),
            ...
            if (arrCod[0] == strIdCargoFijo || arrCod[0] == strIdServicioAdicional) {
                ...
                if (arrCod[0] == strIdCargoFijo) {  //divDesCargFijo
                    ...
                    //INI - validación de cantidad máxima de decos a instalar
                    that.getDecosMatriz();//obtener la cantidad máxima de decos a instalar.
                    that.getDecosInstalados();
                    //FIN - validación de cantidad de decos
        ...
        cboDiscountSA_change: function () {
           ...
           tcboDiscountSA = $('#cboDiscountSA option:selected').text();
            ...
            objLstAccionType.strIdSession = Session.IDSESSION;
            objLstAccionType.strTantoPorciento = tcboDiscountSA;
            objLstAccionType.strCostoInst = controls.txtCostInst.text();
        ...
        GetCommercialServices: function () {
            ...
            objCacDacType.strIdSession = Session.IDSESSION;
            objCacDacType.strCoId = Session.DATACUSTOMER.ContratoID; //CAMBIO
        ...
        getDecosInstalados: function () {
            ...
            param.strIdSession = Session.IDSESSION;
            param.strContratoID = Session.DATACUSTOMER.ContractID;
        ...
        f_LoadCombo: function (URL, BE, Combo, bSelect, Event, basync) {
            ...
            $.app.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.objFinalResponse != null) {
                        $.each(response.objFinalResponse, function (index, value) {
                            if (Event == null) {
    ...
    $.fn.LTEFidelizacionServices = function () {
        ...
        this.each(function () {
            var $this = $(this),
                data = $this.data('LTEFidelizacionServices'),
                options = $.extend({}, $.fn.LTEFidelizacionServices.defaults,
                    $this.data(), typeof option === 'object' && option);

            if (!data) {
                data = new Form($this, options);
                $this.data('LTEFidelizacionServices', data);
            }
    ...
    $.fn.LTEFidelizacionServices.defaults = {
    }

    $('#divBody').LTEFidelizacionServices();
})(jQuery);