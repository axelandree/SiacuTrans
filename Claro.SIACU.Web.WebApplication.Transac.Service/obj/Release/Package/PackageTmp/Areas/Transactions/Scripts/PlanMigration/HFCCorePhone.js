...
(function ($, undefined) {
    ...
    var Form = function ($element, options) {
        ...
        $.extend(this, $.fn.CoreTelefono.defaults, $element.data(), typeof options === 'object' && options);

        this.setControls({
            form: $element
            , tblCoreTelephone: $('#tblCoreTelephone', $element)
        });
    ...
    Form.prototype = {
        ...
        getLoadDetailVisualizeCall: function () {
            ...
            controls.tblCoreTelephone.DataTable({
    ...
    $.fn.CoreTelefono = function () {
        ...
        this.each(function () {
            ...
            var $this = $(this),
                data = $this.data('CoreTelefono'),
                options = $.extend({}, $.fn.CoreTelefono.defaults,
                    $this.data(), typeof option === 'object' && option);

            if (!data) {
                data = new Form($this, options);
                $this.data('CoreTelefono', data);
            }
    ...
    $.fn.CoreTelefono.defaults = {
    };

    $('#CoreTelefono').CoreTelefono();
})(jQuery);
