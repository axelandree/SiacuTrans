...
(function ($) {
    ...
    var Form = function ($element, options) {
        $.extend(this, $.fn.HfcCheckDevices.defaults, $element.data(), typeof options === 'object' && options);
        this.setControls({
            form: $element,
            //DIVS
    ...
    Form.prototype = {
        ...
        getPageLoad_HFC: function () {
            ...
            $.app.ajax({
                ...
                url: location.protocol + "//" + location.host + "/Transactions/HFC/CheckDevices/PageLoad_HFC",
        ...
        LoadDataCheckDevices: function () {
            ...
            $.app.ajax({
                ...
                dataType: 'json',
                data: JSON.stringify(param),
                url: location.protocol + "//" + location.host + "/Transactions/HFC/CheckDevices/GetProductDetails",
                success: function (response) {
                    //console.logresponse);
    ...
    $.fn.HfcCheckDevices = function () {
        ...
        this.each(function () {
            ...
            var $this = $(this),
                data = $this.data('HfcCheckDevices'),
                options = $.extend({}, $.fn.HfcCheckDevices.defaults,
                    $this.data(), typeof option === 'object' && option);

            if (!data) {
                data = new Form($this, options);
                $this.data('HfcCheckDevices', data);
            }
    ...
    $.fn.HfcCheckDevices.defaults = {
    };

    $('#divBody').HfcCheckDevices();
})(jQuery);