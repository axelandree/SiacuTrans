    ...
    var Form = function ($element, options) {
        ...
        this.setControls({
           ...
           , lblContract: $('#lblContract', $element)
            ...
            , cboSOTAssociate: $('#cboSOTAssociate', $element)
            , sltSOTAssociate: $('#sltSOTAssociate', $element)
        });
    }
    Form.prototype = {
        constructor: Form,
        init: function () {
            ...
            controls.cboSOTAssociate.addEvent(that, 'change', that.cboSOTAssociate_change);
        ...
        getAutentificationWindows: function () {
            ...
            var param = {
                ...
                'pag': '1',
                'opcion': "strLlavePermisoCambioEquipoDecoTipo", 
                'co': '1000000000000'
            };
        ...
        LTEChangeEquipmentLoad: function () {
            ...
            return $.app.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                url: '/Transactions/DTH/ChangeEquipment/DTHChangeEquipmentLoad',
        ...
        setSessionData: function () {
            ...
            //controls.lblphone.html((Session.DATACUSTOMER.objPostDataAccount.PhoneContact == null) ? '' : Session.DATACUSTOMER.objPostDataAccount.PhoneContact);
        ...
        render: function () {
            ...
            if (that.objChangeEquipmentLoad.lstSOTListypes != null && that.objChangeEquipmentLoad.lstSOTListypes.length > 0) {
                that.getSOTAssociate(that.objChangeEquipmentLoad.lstSOTListypes);
            } else {
        ...
        chkEmail_change: function (sender, arg) {
            ...
            if (sender.prop('checked')) {
                ...
                that.strCheckEmail = 'S';
            } else {
                controls.divEmailEnviar.hide();
                that.strCheckEmail = 'N';
            }
        },
        ...
        btnDissasociateEquiment_Click_Pop: function () {
            ...
            if (filaSeleccionada.EquipmentSeriesNumber != undefined) {
                ...
                urlBase = location.protocol +
                    '//' +
                    location.host +
                    '/Transactions/DTH/ChangeEquipment/DTHChangeEquipmentAssociate';
                var objModel = {};
        ...
        btnSave_click: function () {
            ...
            objRequestDataModel.strCustomerID = Session.DATACUSTOMER.CustomerID;
            objRequestDataModel.strAccount = Session.DATACUSTOMER.Account;
            ...
            objRequestDataModel.blnCheckEmail = that.strCheckEmail == 'S' ? true : false;
            objRequestDataModel.strCheckEmail = that.strCheckEmail;
            objRequestDataModel.strCacDac = controls.cboSOTAssociate.val();
            objRequestDataModel.strCacDacDescription = $('#cboSOTAssociate option:selected').html();
            objRequestDataModel.strSendEmail = that.strCheckEmail == 'S' ? controls.txtEmailSend.val() : '';
            ...
            objRequestDataModel.strSOTAssociateCode = controls.cboSOTAssociate.val();
            objRequestDataModel.strSOTAssociate = $('#cboSOTAssociate option:selected').html();
            ...
            objRequestDataModel.strNumberTelephone = Session.DATACUSTOMER.PhoneContact;
            ...
            $.app.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                dataType: 'json',
                url: '/Transactions/DTH/ChangeEquipment/Save',
                data: JSON.stringify(objRequestDataModel),
                success: function (response) {
        ...
        getSOTAssociate: function (lstSOTListypes) {
            debugger;
            if (lstSOTListypes.length > 0) {
               var that = this,
               controls = that.getControls();
               controls.cboSOTAssociate.append($('<option>', { value: '', html: 'Seleccionar' }));
               var itemSelect;
               $.each(lstSOTListypes, function (index, value) {
                   controls.cboSOTAssociate.append($('<option>', { value: value.Code, html: value.Description }));
                   itemSelect = value.Code;
               });
               if (itemSelect != null && itemSelect.toString != "undefined") {
                   $("#cboSOTAssociate option[value=" + itemSelect + "]").attr("selected", true);
               }
            }
        },

        cboSOTAssociate_change: function (SOTAssociate) {
            debugger;
            var that = this,
            controls = that.getControls();
            var SOTAssociate = controls.cboSOTAssociate.val();
            $("#cboSOTAssociate option[value=" + SOTAssociate + "]").attr("selected", true);
        },
