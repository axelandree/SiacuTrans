...
namespace Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad {
    ...
    public interface ConsultaSeguridad {
        ...
        Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuResponse leerOpcionesMenu(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://claro.com.pe/eai/utilitiesservices/seguridad/consultaseguridad/leerOpcione" +
            "sMenu", ReplyAction="*")]
        System.Threading.Tasks.Task<Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuResponse> leerOpcionesMenuAsync(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuRequest request);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://claro.com.pe/eai/utilitiesservices/seguridad/consultaseguridad/verificaUsu" +
            "ario", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioResponse verificaUsuario(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://claro.com.pe/eai/utilitiesservices/seguridad/consultaseguridad/verificaUsu" +
            "ario", ReplyAction="*")]
        System.Threading.Tasks.Task<Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioResponse> verificaUsuarioAsync(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioRequest request);
    }
    ...
    public partial class leerOpcionesMenuResponse {
        ...
        public Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.menuType[] cursor_Menu;
        
        public leerOpcionesMenuResponse() {
        }
        
        public leerOpcionesMenuResponse(string idTransaccion, string errorCode, string errorMsg, Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.menuType[] cursor_Menu) {
            this.idTransaccion = idTransaccion;
    ...
    public partial class verificaUsuarioResponse {
        ...
        public Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.seguridadType[] cursorSeguridad;
        
        public verificaUsuarioResponse() {
        }
        
        public verificaUsuarioResponse(string idTransaccion, string errorCode, string errorMsg, Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.seguridadType[] cursorSeguridad) {
            this.idTransaccion = idTransaccion;
            this.errorCode = errorCode;
            this.errorMsg = errorMsg;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ConsultaSeguridadChannel : Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.ConsultaSeguridad, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaSeguridadClient : System.ServiceModel.ClientBase<Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.ConsultaSeguridad>, Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.ConsultaSeguridad {
        ...
        Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuResponse Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.ConsultaSeguridad.leerOpcionesMenu(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuRequest request) {
            return base.Channel.leerOpcionesMenu(request);
        }
        
        public string leerOpcionesMenu(ref string idTransaccion, string ipAplicacion, string aplicacion, long usuario, long appCod, long nivel, long opcPadre, out string errorMsg, out Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.menuType[] cursor_Menu) {
            Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuRequest inValue = new Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuRequest();
            ...
            Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuResponse retVal = ((Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.ConsultaSeguridad)(this)).leerOpcionesMenu(inValue);
        ...
        public System.Threading.Tasks.Task<Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuResponse> leerOpcionesMenuAsync(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.leerOpcionesMenuRequest request) {
            return base.Channel.leerOpcionesMenuAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioResponse Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.ConsultaSeguridad.verificaUsuario(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioRequest request) {
            return base.Channel.verificaUsuario(request);
        }
        
        public string verificaUsuario(ref string idTransaccion, string ipAplicacion, string aplicacion, string usuarioLogin, long appCod, out string errorMsg, out Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.seguridadType[] cursorSeguridad) {
            Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioRequest inValue = new Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioRequest();
            inValue.idTransaccion = idTransaccion;
            inValue.ipAplicacion = ipAplicacion;
            inValue.aplicacion = aplicacion;
            inValue.usuarioLogin = usuarioLogin;
            inValue.appCod = appCod;
            Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioResponse retVal = ((Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.ConsultaSeguridad)(this)).verificaUsuario(inValue);
            idTransaccion = retVal.idTransaccion;
            errorMsg = retVal.errorMsg;
        ...
        public System.Threading.Tasks.Task<Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioResponse> verificaUsuarioAsync(Claro.SIACU.ProxyService.Transac.Service.SIACUConsultaSeguridad.verificaUsuarioRequest request) {
