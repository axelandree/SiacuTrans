...
namespace Claro.SIACU.Web.Service.Transac.Service
{
    ...
    public class PostTransacService : IPostTransacService
    {
        ...
        /// <param name="strContrato"></param>
        /// <returns></returns>
        public bool validarAccesoRegistroLinkMovil(string strIdSession, string strIdTransaccion, parametroMovil oparametroMovil)
        {
            bool booAccedeLink = false;
            booAccedeLink = Claro.Web.Logging.ExecuteMethod<bool>(strIdSession, strIdTransaccion, () =>
            {
                return Business.Transac.Service.Postpaid.NetflixServices.validarAccesoRegistroLinkMovil(strIdSession, strIdTransaccion, oparametroMovil);
            });
        ...
        public ServicesNXResponse envioNotificacionRegistroNX(string strIdSession, string strIdTransaccion, ServicesNXRequest oRequest, AuditRequest oAuditRequest)
        {
            ...
            try
            {
                ...
                {
                    return Business.Transac.Service.Postpaid.NetflixServices.envioNotificacionRegistroNX(strIdSession, strIdTransaccion, oRequest, oAuditRequest);
                });
            }
             catch (Exception ex)
            {
