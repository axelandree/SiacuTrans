...
namespace Claro.SIACU.Data.Transac.Service.Fixed
{
    public class AdditionalServices
    {
        ...
        public static List<EntitiesFixed.CommercialService> GetCommercialServices(string strIdSession, string strTransaction, string strCoId)
        {
            ...
            Web.Logging.Info(strIdSession, strTransaction, "GetCommercialServices() salida: salida.count:" + salida.Count);//INC000004211915//
            return salida;
        }
        ...
        public static bool GetCommertialPlan(string strIdSession, string strTransaction, string strCoId, ref string rCodigoPlan, ref int rintCodigoError, ref string rstrDescripcionError)
        {
            ...
            //INC000004211915//
            Web.Logging.Info(strIdSession, strTransaction, "GetCommertialPlan() salida: " + salida);
            Web.Logging.Info(strIdSession, strTransaction, "GetCommertialPlan() rCodigoPlan: " + rCodigoPlan);
            Web.Logging.Info(strIdSession, strTransaction, "GetCommertialPlan() rintCodigoError: " + rintCodigoError.ToString());
            Web.Logging.Info(strIdSession, strTransaction, "GetCommertialPlan() rstrDescripcionError: " + rstrDescripcionError);
            //INC000004211915//
            return salida;
        }
        ...
        public static List<EntitiesFixed.PlanService> GetPlanServices(string strIdSession, string strTransaction, string idplan, string typeProduct)
        {
            ...
            //INC000004211915//
            Web.Logging.Info(strIdSession, strTransaction, "GetPlanServices: salida.count: " + salida.Count);
            return salida;
        }
