    ...
    public class PlanMigrationHfc
    {
        ...
        public static Entity.Transac.Service.Fixed.GetPlans.PlansResponse GetPlans(Entity.Transac.Service.Fixed.GetPlans.PlansRequest objPlansRequest)
        {
            ...
            try
            {
                ...
                {
                    return Data.Transac.Service.Fixed.PlanMigrationHfc.GetNewPlans(objPlansRequest.Audit.Session, objPlansRequest.Audit.Transaction, objPlansRequest.strPlano, objPlansRequest.strOferta, objPlansRequest.strTipoProducto);
                });
        ...
        public static Entity.Transac.Service.Fixed.GetServicesByPlan.PlanServiceResponse GetServicesByPlan(Entity.Transac.Service.Fixed.GetServicesByPlan.PlanServiceRequest objServicesRequest)
        {
            ...
            try
            {
                ...
                {
                    return Data.Transac.Service.Fixed.PlanMigrationHfc.GetServicesByPlan(objServicesRequest.Audit.Session, objServicesRequest.Audit.Transaction, objServicesRequest.idplan, objServicesRequest.strTipoProducto);
                });
        ...
        public static Entity.Transac.Service.Fixed.ExecutePlanMigrationLte.MigratedPlanResponse ExecutePlanMigrationHfc(Entity.Transac.Service.Fixed.ExecutePlanMigrationLte.MigratedPlanRequest RequestParam)
        {
            OsbLteEntity listService = new OsbLteEntity();
            try
            {
                listService = Claro.Web.Logging.ExecuteMethod<OsbLteEntity>(RequestParam.Audit.Session, RequestParam.Audit.Transaction, () =>
                {
                    return Data.Transac.Service.Fixed.PlanMigrationHfc.ExecutePlanMigrationHfc(RequestParam.Audit.Session, RequestParam.Audit.Transaction, RequestParam.TransactionId, RequestParam.ServicesList, RequestParam.Tipification, RequestParam.ClientParameters, RequestParam.MainParameters, RequestParam.PlusParameters, RequestParam.EtaSelection, RequestParam.SotParameters, RequestParam.EtaParameters, RequestParam.Contract, RequestParam.ActualizarTipificacion, RequestParam.FlagContingencia, RequestParam.FlagCrearPlantilla, RequestParam.AuditRegister, RequestParam.ListCoser, RequestParam.FlagValidaEta, RequestParam.ParametrosConstancia, RequestParam.DestinatarioCorreo, RequestParam.Notes, RequestParam.strTipoProducto);
                });

            }
            catch (Exception ex)
            {
                Claro.Web.Logging.Info(RequestParam.Audit.Session, RequestParam.Audit.Transaction, "PLANMIGRATIONHFC_EXCEPCION DE LLAMADA EN CAPA DATA: ");
        ...
        public static Entity.Transac.Service.Fixed.GetTechnicalVisitResult.TechnicalVisitResultResponse GetTechnicalVisitResult(Entity.Transac.Service.Fixed.GetTechnicalVisitResult.TechnicalVisitResultRequest RequestParam)
        {
            ...
            try
            {
                ...
                {
                    return Data.Transac.Service.Fixed.PlanMigrationHfc.GetTechnicalVisitResult(RequestParam.Audit.Session, RequestParam.Audit.Transaction, RequestParam.strCoId, RequestParam.strCustomerId, RequestParam.strTmCode, RequestParam.strCodPlanSisact, RequestParam.strTrama);
                });
        ...
        #region Proy-32650
        public static Entity.Transac.Service.Fixed.GetCaseInsert.RetentionCancelServicesResponse GetCurrentDiscountFixedCharge(Entity.Transac.Service.Fixed.GetCaseInsert.RetentionCancelServicesRequest objRequest)
        {
            var objResponse = new Entity.Transac.Service.Fixed.GetCaseInsert.RetentionCancelServicesResponse();

            string codError = string.Empty, descError = string.Empty;
            objResponse.CurrentDiscounts = new List<CurrentDiscountFixedCharge>();
            try
            {
                objResponse.CurrentDiscounts = Claro.Web.Logging.ExecuteMethod<List<Entity.Transac.Service.Fixed.CurrentDiscountFixedCharge>>(objRequest.Audit.Session, objRequest.Audit.Transaction, () =>
                {
                    return Claro.SIACU.Data.Transac.Service.Fixed.PlanMigrationHfc.GetCurrentDiscountFixedCharge(objRequest.Audit.Session, objRequest.Audit.Transaction, objRequest.CodId, ref codError, ref descError);
                });               
            }
            catch (Exception ex)
            {
            ...
            objResponse.CodMessage = codError;
            objResponse.Message = descError;
            return objResponse;

        }

        public static Entity.Transac.Service.Fixed.GetCaseInsert.RetentionCancelServicesResponse InsertDiscountBondExchangePlan(Entity.Transac.Service.Fixed.GetCaseInsert.RetentionCancelServicesRequest objRequest)
        {
            var objResponse = new Entity.Transac.Service.Fixed.GetCaseInsert.RetentionCancelServicesResponse();
            string codError = string.Empty, descError = string.Empty;
            try
            {               
                objResponse.Resultado = Web.Logging.ExecuteMethod(objRequest.Audit.Session, objRequest.Audit.Transaction, () =>
                {
                    ...
                    return Claro.SIACU.Data.Transac.Service.Fixed.PlanMigrationHfc.InsertDiscountBondExchangePlan(objRequest.Audit.Session, objRequest.Audit.Transaction,
                        objRequest.CustumerId,objRequest.CodId, objRequest.SnCode, objRequest.TmCodeCom, ref codError, ref descError);
                });               
            }
            catch (Exception ex)
            {
